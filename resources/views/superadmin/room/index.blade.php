                            ...
                            @if(count($rooms)>0)
                                @foreach($rooms as $key=>$room)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="" class="btn btn-sm d-block btn-secondary">View</a>

                                            <a href="{{route('superadmin.room.edit', ['id'=>$room->id])}}" class="btn btn-sm d-block btn-primary my-1">Edit</a>
...
<div class="modal fade modal-danger" id="deleteRoom" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog model-sm" role="document">
	    <div class="modal-content">
            ...
            <form action="{{route('superadmin.room.destroy','room')}}" method="post">
                @csrf
